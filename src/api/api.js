...
// 机构管理
const queryOrgTreeList = (params)=>getAction("/baseInstitution/queryIdTree",params);
const deleteByOrgtId   = (params)=>deleteAction("/baseInstitution/delete",params);
//日志管理
...
// 部署流程图文件
const deployHandle = (params)=>getAction("/sys/user/frozenBatch",params);
