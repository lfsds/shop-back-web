    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="内容"><a-input placeholder="请输入内容" v-model="queryParam.content"></a-input></a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="类型">
                <a-select v-model="queryParam.type" allowClear style="width: 100%" placeholder="请选择类型">
                  <a-select-option :value="1">政策法规</a-select-option>
                  <a-select-option :value="2">新闻</a-select-option>
                  <a-select-option :value="3">园区动态</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="发布时间"><a-input placeholder="请输入发布时间" v-model="queryParam.publishTime"></a-input></a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="创建时间"><a-input placeholder="请输入创建时间" v-model="queryParam.createdAt"></a-input></a-form-item>
            </a-col>
          </template>
          <a-col :md="6" :sm="8">
