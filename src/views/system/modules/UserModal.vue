    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="用户账号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入用户账号" :disabled="model.id?true:false" v-decorator="[ 'username', validatorRules.username]" :readOnly="!!model.id"/>
        </a-form-item>
        ...
        <a-form-item label="用户名字" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-input placeholder="请输入用户名称" :disabled="model.id?true:false" v-decorator="[ 'realname', validatorRules.realname]" />
        </a-form-item>
        ...
        <a-form-item label="性别" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select v-decorator="[ 'sex', {}]" :disabled="model.id?true:false" placeholder="请选择性别">
        ...
        <a-form-item label="邮箱" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入邮箱" :disabled="model.id?true:false" v-decorator="[ 'email', validatorRules.email]" />
        </a-form-item>

        <a-form-item label="手机号码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入手机号码" :disabled="model.id?true:false" v-decorator="[ 'phone', validatorRules.phone]" />
        </a-form-item>
<!--        <a-form-item label="手机号码" :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--          <a-input placeholder="请输入手机号码" :disabled="isDisabledAuth('user:form:phone')" v-decorator="[ 'phone', validatorRules.phone]" />-->
<!--        </a-form-item>-->
        <a-form-item label="工作流引擎" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag  v-decorator="['activitiSync', {}]" placeholder="请选择是否同步工作流引擎" :disabled="model.id?true:false" :type="'radio'" :triggerChange="true" dictCode="activiti_sync"/>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      validateToNextPassword  (rule, value, callback) {
        ...
        // }
        // if (value && confirmpassword && value !== confirmpassword) {
        //   form.setFieldsValue({confirmpassword: '2222222'})
        // }
